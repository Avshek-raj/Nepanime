...
export const SearchResults = () => {
    ...
    if (!query) {
        return <div className="text-center text-white/70 mt-10 px-5">Please enter a search query.</div>;
    }
    ...
    return (
        <div className="px-5 py-10 min-h-screen">
            <h1 className="text-2xl sm:text-3xl font-bold mb-6">Search Results for "{query}"</h1>
